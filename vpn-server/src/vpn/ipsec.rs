...
impl IpsecBackend {
    pub fn new() -> Result<Self> {
        Ok(Self { ike_port_main: 500, ike_port_nat: 4500 })
    }
...
"#);
    ...
    fn parse_status() -> BackendStatus {
        ...
        BackendStatus { protocol: "ikev2".into(), active_sessions: active, egress_bytes: 0, ingress_bytes: 0, running: true }
    }
}

impl VpnBackend for IpsecBackend {
    fn protocol(&self) -> VpnProtocol { VpnProtocol::IkeV2 }
